function updateFilterLabels() {
    ...
    document.querySelectorAll('.type-filter-link').forEach(link => {
        ...
        if (isMobile) {
            if (link.dataset.original === "Income") link.textContent = "In";
            else if (link.dataset.original === "Outcome") link.textContent = "Out";
